...
async function SuppliersText({ slo, srb }: { slo?: boolean; srb?: boolean }) {
  ...
  return (
    <div className="mt-12 flex flex-col gap-10 md:mt-20 md:gap-20 lg:gap-40">
      <div className="flex flex-col gap-8 font-light text-secondary">
        ...
        <ul className="flex list-inside list-image-check flex-col gap-4 font-bold text-primary">
          <li>
            ISO 9001
            <br />
            <br />
      ...
      <div className="relative mx-auto h-56 w-full md:w-2/3 lg:h-80">
        <Image
          src={img}
