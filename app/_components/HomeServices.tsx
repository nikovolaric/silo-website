...
function HomeServices({ srb, slo }: { srb?: boolean; slo?: boolean }) {
  return (
    <>
      <div className="mt-14 flex flex-col gap-24 lg:mt-24">
        <HomeServiceCard
          title={
            slo ? "Silo transport" : srb ? "Silo transport" : "Silo transport"
          }
        ...
        >
          {slo
            ? "Naši novi Vakuum silos vam je na voljo za sesalno čiščenje, prenos in sušenje vseh vrst suhih razsutih materialov kjerkoli v Evropi."
            : srb
              ? "Naši novi Vakuum silos vam je na raspolaganju za usisno čišćenje, prenošenje i feniranje svih vrsta suvih rasutih materijala bilo gde u Evropi."
