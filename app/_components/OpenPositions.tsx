...
async function OpenPositions({ srb, slo }: { srb?: boolean; slo?: boolean }) {
  ...
  if (!data.results) {
    return (
      <div className="mt-20 lg:mt-24 flex flex-col gap-6">
        <h4 className="font-raj font-semibold text-2xl text-primary">
          {srb
  ...
  if (data.results) {
    return (
      <div className="mt-20 lg:mt-24">
        <h5 className="font-bold font-raj text-xl xl:w-5/6 xl:mx-auto">
          {srb
